...
public class FragmentBackStackA extends Fragment {

	private static final String TAG = "tuacy";

	public static FragmentBackStackA instance() {
		return new FragmentBackStackA();
	}
	...
	public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
		...
		return inflater.inflate(R.layout.fragment_back_stack_a, container, false);
	}
